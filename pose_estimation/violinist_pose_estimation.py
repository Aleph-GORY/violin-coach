...
from model_zoo.model_api.models import ImageModel, OutputTransform
...
from model_zoo.model_api.adapters import create_core, OpenvinoAdapter

import common.monitors as monitors
from common.images_capture import open_images_capture, resolution 
...
def build_argparser():
    ...
    args.add_argument('-at', '--architecture_type', help='Required. Specify model\' architecture type.',
                      type=str, required=True, choices=tuple(ARCHITECTURES.keys()))
...
def draw_poses(img, poses, point_score_threshold, output_transform, skeleton=default_skeleton, draw_ellipses=True):
...
def main():
    ...
    metrics.log_total()
    monitors.log_latency_per_stage(cap.reader_metrics.get_latency(),
